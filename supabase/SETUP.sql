-- BoardBuddy full database setup (run once in Supabase SQL Editor)

-- ===== supabase/migrations/20260821092457_0b869eb1-bfea-4bb3-adb0-99271fcf8711.sql =====
-- ENUM
...
-- LEADERBOARD (real stats: accuracy + tests count from attempts)
...
-- ===== supabase/migrations/20260822112353_b805cac5-c371-49b0-bae7-393fa30d2b66.sql =====
CREATE OR REPLACE FUNCTION public.claim_owner()
RETURNS boolean LANGUAGE plpgsql SECURITY DEFINER SET search_path = public AS $$
DECLARE uid uuid := auth.uid();
DECLARE uemail text;
